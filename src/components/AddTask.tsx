      ...
      <Modal modalOpen={modalOpen} setModalOpen={setModalOpen}>
        <form id="2" onSubmit={handleSubmitNewTodo} className="space-y-2">
          <input
            ...
            placeholder="Title"
            required
            className="input input-bordered w-full bg-white text-black mt-1"
          />
          <textarea
            ...
            required
            className="input input-bordered w-full h-28 p-4 bg-white text-black"
          />
          <div
            ref={wrapperRef1}
            style={{ position: "relative", width: "100%" }}
          >
            <div className="text-gray-600 text-start w-full p-1">Priority:</div>
            <input
              type="text"
              onFocus={() => setShowDropdownPriority(true)}
              placeholder="Priority"
              className="w-full h-10 bg-white text-black p-4"
          ...
          <div ref={wrapperRef} style={{ position: "relative", width: "100%" }}>
            <div className="text-gray-600 text-start w-full p-1">Status:</div>
            <input
              type="text"
          ...
          <div className="w-full">
            <div className="text-gray-600 text-start w-full p-1">Due Date:</div>
            <input
              type="date"
          ...
          <div className="w-full">
            <div className="text-gray-700 p-2 text-left w-full">
              Upload Task Image
            </div>
            <input
              type="file"
