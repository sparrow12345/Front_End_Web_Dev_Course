...
export default function Home() {
  return (
    <main className="text-gray-900">
      <section className="pt-40 md:pt-40 mx-auto  min-h-screen justify-between xl:p-24 bg-zinc-100">
        <div className="container mx-auto px-8 lg:flex">
          <div className="text-center lg:text-left lg:w-1/2 xl:pt-20">
            <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold leading-none">
              Revolutionize Your Productivity
            </h1>
            <p className="text-xl lg:text-2xl mt-6 font-light">
              Our intuitive design and powerful features make staying organized
              effortless and enjoyable
            </p>
            <p className="mt-8 md:mt-12">
              <Link
                className="btn btn-primary w-1/2 items-center mx-auto text-white"
                href="/mytasks"
              >
                Try it Now!
              </Link>
